...
import 'package:frontend_customer/services/buy_requests_service.dart';
      ...
      body: _notifications.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final status = _notifications[index]['status'];

                String message = "";

                if (status == 'accepted') {
                  message =
                      "Your request from ${notification['farmer']['name']} for ${notification['inventory']['cropName']} was accepted";
                } else if (status == 'rejected') {
                  message =
                      "Your request from ${notification['farmer']['name']} for ${notification['inventory']['cropName']} was rejected";
                }
